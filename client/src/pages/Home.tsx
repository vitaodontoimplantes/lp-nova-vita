...
export default function Home() {
  return <div className="min-h-screen overflow-x-hidden bg-paper text-ink">
    ...
    <main>
      <section id="inicio" className="ppc-hero hero-section"><div className="hero-orb hero-orb-one" /><div className="container relative grid items-center gap-9 py-12 sm:py-16 lg:grid-cols-[0.92fr_1.08fr] lg:gap-16 lg:py-16"><div className="relative z-10 max-w-[590px] animate-fade-up"><div className="eyebrow"><span className="eyebrow-line" /> Clínica de implantes em Curitiba</div><h1 className="mt-6 font-display text-[3.25rem] leading-[0.97] tracking-[-0.05em] sm:text-[4.55rem]">Volte a sorrir com <em className="text-gold">segurança.</em></h1><p className="mt-5 max-w-[500px] text-[1rem] leading-7 text-ink/65">Avaliação individual, planejamento digital e atendimento especializado para o seu caso.</p><div className="mt-7 flex flex-col items-start gap-3 sm:flex-row sm:items-center"><WhatsAppButton /><span className="flex items-center gap-2 text-xs text-ink/50"><ShieldCheck size={15} className="text-gold" /> Sem compromisso</span></div><div className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-[0.69rem] font-bold uppercase tracking-[0.1em] text-ink/55"><span className="flex items-center gap-2"><Check size={14} className="text-gold" /> Clínica física</span><span className="flex items-center gap-2"><Check size={14} className="text-gold" /> Equipe especializada</span><span className="flex items-center gap-2"><Check size={14} className="text-gold" /> Planejamento digital</span></div></div><div className="hero-visual ppc-hero-visual animate-fade-in"><div className="hero-image-wrap"><img src="/manus-storage/clinica-hero_7757a1f7.jpg" alt="Profissional da Vita Sorriso na clínica de implantes" className="hero-image" /><div className="hero-image-shade" /></div><div className="hero-note hero-note-top"><span className="note-icon"><Star size={14} fill="currentColor" /></span><span><strong>4,9</strong><small>no Google</small></span></div><div className="hero-note hero-note-bottom"><span className="note-icon note-icon-dark"><Check size={15} /></span><span><strong>+2.000</strong><small>sorrisos atendidos</small></span></div></div></div></section>
